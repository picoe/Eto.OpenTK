    ...
    public class etoViewport : Panel
    {
        ...
        public void drawGrid()
        {
            if (ovpSettings.showGrid)
            {
                ...
                {
                    int k = 0;
                    for (float i = 0; i > -(Width + Math.Abs(ovpSettings.cameraPosition.X)) * ovpSettings.zoomFactor; i -= spacing)
                    {
                        float r = 0.0f;
                        float g = 0.0f;
                        float b = 0.0f;
                        ...
                        k++;
                        grid.Add(new Vector3(i, (Height + Math.Abs(ovpSettings.cameraPosition.Y)) * ovpSettings.zoomFactor, gridZ));
                    ...
                    k = 0;
                    for (float i = 0; i > -(Height + Math.Abs(ovpSettings.cameraPosition.Y)) * ovpSettings.zoomFactor; i -= spacing)
                    {
                        float r = 0.0f;
                        float g = 0.0f;
                        float b = 0.0f;
                        ...
                        k++;
                        grid.Add(new Vector3((Width + Math.Abs(ovpSettings.cameraPosition.X)) * ovpSettings.zoomFactor, i, gridZ));
                        gridColors.Add(new Vector3(r, g, b));
                        grid.Add(new Vector3(-(Width + Math.Abs(ovpSettings.cameraPosition.X)) * ovpSettings.zoomFactor, i, gridZ));
                        gridColors.Add(new Vector3(r, g, b));
                    }
        ...
        public void drawAxes()
        {
            if (ovpSettings.showAxes)
            {
                ...
                axesArray[0] = new Vector3(0.0f, (Height + Math.Abs(ovpSettings.cameraPosition.Y)) * ovpSettings.zoomFactor, axisZ);
                axesArray[1] = new Vector3(0.0f, -(Height + Math.Abs(ovpSettings.cameraPosition.Y)) * ovpSettings.zoomFactor, axisZ);
                axesArray[2] = new Vector3((Width + Math.Abs(ovpSettings.cameraPosition.X)) * ovpSettings.zoomFactor, 0.0f, axisZ);
                axesArray[3] = new Vector3(-(Width + Math.Abs(ovpSettings.cameraPosition.X)) * ovpSettings.zoomFactor, 0.0f, axisZ);
            }
        }
    }
}
