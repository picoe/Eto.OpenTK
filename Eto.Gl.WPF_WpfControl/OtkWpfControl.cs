...
namespace Eto.Gl.WPF_WpfControl
{
	...
	public class OtkWpfControl : UserControl
	{
		...
		public OtkWpfControl() : this(GraphicsMode.Default)
		{
		}

		public OtkWpfControl(GraphicsMode mode)
            : this(mode, 3, 0, GraphicsContextFlags.Default)
        { }

		public OtkWpfControl(GraphicsMode mode, int major, int minor, GraphicsContextFlags flags)
		{
			graphicsMode = mode;
			this.major = major;
			this.minor = minor;
		...
		public override void OnApplyTemplate()
		{
			...
			mTkGlControl = new GLControl( graphicsMode , major , minor , flags );
